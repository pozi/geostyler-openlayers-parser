...
import { drawSvgToCanvas, getDecodedSvg, getEncodedSvg, getSvgProperties, LINE_WELLKNOWNNAMES, NOFILL_WELLKNOWNNAMES } from './Util/OlSvgUtil';
/**
...
export class OlStyleParser {
    ...
    getPointSymbolizerFromOlStyle(olStyle) {
        ...
        if (olStyle.getImage() instanceof this.OlStyleCircleConstructor) {
            ...
            const iconSrc = olIconStyle.getSrc();
            let svgString;
    ...
    getOlPatternFromGraphicFill(graphicFill) {
        ...
        if (isIconSymbolizer(graphicFill)) {
            const graphicFillStyle = this.getOlIconSymbolizerFromIconSymbolizer(graphicFill);
        ...
        const diameter = (graphicFill.radius ?? 4) * 2;
